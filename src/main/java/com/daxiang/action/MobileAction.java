 ...
 */
@Slf4j
//note by yifeng, MobileAction是适用于所有ios/Android设备的，目前无
//ios需求，同一改成android用例
public class MobileAction extends BaseAction {
    ...
    //add by yifeng, 增加串口设备构造函数
    public MobileAction(TvDevice tvDevice) {
        super(tvDevice);
    ...
    @Action(id = 1000, name = "[android]切换context", platforms = {1, 2})
    ...
    @Action(id = 1003, name = "[android]滑动屏幕", platforms = {1, 2})
    ...
    @Action(id = 1004, name = "[android]滑动屏幕查找元素", platforms = {1, 2})
    ...
    @Action(id = 1005, name = "[android]容器内滑动", platforms = {1, 2})
    ...
    @Action(id = 1006, name = "[android]容器内滑动查找元素", platforms = {1, 2})
    ...
    @Action(id = 1011, name = "[android]点击", platforms = {1, 2})
    ...
    @Action(id = 1012, name = "[android]长按元素", platforms = {1, 2})
